...
const TourWizard = () => {
  ...
  const handleCreateNewDivision = async () => {
    ...
    try {
      ...
      const res = await axios.post('/api/divisions', 
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      if (isEditing && tourId) {
        ...
        const res = await axios.put(`/api/tours/${tourId}`, tourPayload, { headers });
        if (res.data) {
        ...
        // Create new tour
        const res = await axios.post('/api/tours', tourPayload, { headers });
        if (res.data) {
