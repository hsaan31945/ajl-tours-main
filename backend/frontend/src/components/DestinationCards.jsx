...
const DestinationCards = () => {
  ...
  useEffect(() => {
    const fetchTours = async () => {
      try {
        const data = await fetchToursList({ division: 'switzerland', limit: 6 });
        if (data.length) {
        ...
        // Fallback to static data for Switzerland tours
        setTours([
          {
            id: "1",
            ...
            listings: 8,
            route: "/switzerland/1/checkout-sw",
            price: 1200
          },
          {
            id: "2",
            name: "Lake Geneva Explorer",
            image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=800&q=80",
            listings: 12,
            route: "/switzerland/2/checkout-sw",
            price: 950
          },
          {
            id: "3",
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="relative">
              ...
              >
                {tours.filter((tour) => tour.image).map((tour) => (
                  <div
                    key={tour.id}
