 ...
 *   2. Run: node test-new-mongodb-connection.js
 * 
 * Or test with inline connection string:
 *   MONGODB_URI="mongodb+srv://..." node test-new-mongodb-connection.js
 */
...
async function testConnection() {
  ...
  if (!mongoURI) {
    ...
    log('   3. Or set it inline: MONGODB_URI="..." node test-new-mongodb-connection.js', 'yellow');
    process.exit(1);
  }
